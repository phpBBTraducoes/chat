<?php
/** 
* acp.php [Brazilian Portuguese [pt_br]] translation by eunaumtenhoid (c) 2017 [ver 1.1.3] (https://github.com/phpBBTraducoes)
* @package cBB Chat
...
$lang = array_merge($lang, array(
	'CHAT_CONFIG_TITLE'		=> 'Configurar o Chat',
	'CHAT_CONFIG_EXPLAIN'	=> 'Obrigado por escolher cBB Chat como complemento do seu fórum!<br />
A partir desta página, você pode modificar as principais características do chat.',
	'CHAT_PAGES_TITLE'		=> 'Gerenciar páginas',
	'CHAT_PAGES_EXPLAIN'	=> 'Aqui você pode gerenciar as páginas que irão carregar o chat e a posição dele.',
	'CHAT_ROOMS_TITLE'		=> 'Gerenciar salas',
	'CHAT_ROOMS_EXPLAIN'	=> 'Aqui você pode gerenciar as salas especiais para serem exibidas no chat.<br /> Você pode ordenar arrastando as salas para a posição correta.',
	'CHAT_TEXTS_TITLE'		=> 'Gerenciar textos e regras',
	'CHAT_TEXTS_EXPLAIN'	=> 'Aqui você pode gerenciar os anúncios, dicas e regras do chat.<br />
...
<em>Defina 0 para desativar esse limite</em>.',
	...
	'CHAT_ENABLED_EXPLAIN'		=> 'Ativar / Desativar todas as funções do chat.',
...
<em>Defina 0 para desativar esse limite</em>. ',
	...
	'CHAT_HELP'					=> 'Documentação e suporte',
	'CHAT_MAIN_CONFIG'			=> 'Configuração principal',
	'CHAT_MAX_PM'				=> 'Limite de mensagens privadas',
	'CHAT_MAX_PM_EXPLAIN'		=> 'Define o número máximo de mensagens privadas que um usuário pode abrir simultaneamente. <br/><em>Defina 0 para desativar este limite</em>.',
...
Smilies são permitidos.</em>',
	...
	'CUSTOM_FILE'			=> 'Arquivo personalizado',
	'CUSTOM_FILES'			=> 'Arquivos personalizados',
	'DEFAULT_BBCODES'		=> 'BBcodes padrão',
	'FORUM_FILES'			=> 'Arquivos do fórum',
	'MOD_NOT_INSTALLED'		=> 'Mod não instalado corretamente',
	...
	'CHAT_VERSION_NOT_UP_TO_DATE'	=> 'Uma versão mais recente do CBB Chat está disponível. <br />
Abaixo você encontrará um link para o aviso de publicação da versão mais recente e instruções sobre como atualizá-lo.',
));
